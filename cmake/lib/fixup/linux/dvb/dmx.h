...
#define DMX_SET_FILTER           _IOW('o', 43, dmx_sct_filter_params)
#define DMX_SET_PES_FILTER       _IOW('o', 44, dmx_pes_filter_params)
#define DMX_SET_BUFFER_SIZE      _IO('o', 45)
#define DMX_GET_PES_PIDS         _IOR('o', 47, __u16[5])
#define DMX_GET_STC              _IOWR('o', 50, dmx_stc)
...
#define DMX_REQBUFS              _IOWR('o', 60, dmx_requestbuffers)
#define DMX_QUERYBUF             _IOWR('o', 61, dmx_buffer)
#define DMX_EXPBUF               _IOWR('o', 62, dmx_exportbuffer)
#define DMX_QBUF                 _IOWR('o', 63, dmx_buffer)
#define DMX_DQBUF                _IOWR('o', 64, dmx_buffer)
